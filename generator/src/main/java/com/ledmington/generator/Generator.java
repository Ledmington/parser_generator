...
public final class Generator {
	...
	private static void generateLexer(
		...
		sb.append("public ")
				...
				.append("if (isAccepting[currentState]) {\n")
				.indent()
				.append("final int length = lastTokenMatchEnd - lastTokenMatchStart + 1;\n")
				.append("if (length == 0) {\n")
				.indent()
				.append(
				...
				.indent()
				.append(
						"final String match = String.copyValueOf(v, lastTokenMatchStart, lastTokenMatchEnd - lastTokenMatchStart + 1);\n")
				.append("tokens.add(tokensToMatch.get(currentState).apply(match));\n")
				.deindent()
				.append("}\n")
